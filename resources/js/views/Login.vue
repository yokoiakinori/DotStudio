<template>
  <div class="login">
    <ul class="tab">
      <li @click="tab = 1">
        <p :class="{'tab_item-active':tab === 1,'tab_item-nonactive':tab !== 1}">ログイン</p>
      </li>
      <li @click="tab = 2">
        <p :class="{'tab_item-active':tab === 2,'tab_item-nonactive':tab !== 2}">会員登録</p>
      </li>
    </ul>
    <div class="panel" v-show="tab === 1">
      ...
      <form class="form" @submit.prevent="login">
        ...
        <div class="form__button">
          <button type="submit" class="formButton">ログイン</button>
        </div>
      </form>
    </div>
    <div class="panel" v-show="tab === 2">
      ...
      <form class="form" @submit.prevent="register">
        ...
        />
        <div class="form__button">
          <button type="submit" class="formButton">アカウント作成</button>
        </div>
      </form>
    </div>
  </div>
